...
Auch bei einer Erstanschaffung ist ein Gebrauchtkauf immerhin eine Überlegung wert - ein gebrauchtes "Profi"-Modell kann einem neuen Modell der unteren Preisklasse manchmal überlegen sein.
...
Für eine Modernisierung kommen eigentlich nur die 4-Kern-CPUs in Frage, diese bieten auch heutzutage für viele Anwendungsfälle mindestens zufriedenstellende Leistung. Etwas problematisch ist die TDP von 47W der Vierkerner. Für die Hardware (Spannungsregler etc.) ist das kein Problem, das T440p ist darauf ausgelegt. Die Kühlung jedoch stößt an ihre Grenzen, im Betrieb wird das Gerät sehr warm und der Lüfter macht sich lautstark bemerkbar. Es gibt aber eine tolle Alternative, die erst ein Jahr später auf den Markt kam:
