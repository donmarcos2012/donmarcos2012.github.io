...
Das T440p ist mein Arbeitsnotebook geworden. Ich nutze es fürs Studium (Java Programmierung mit Eclipse), zur Bearbeitung meiner Fotografien, Schreiben von Latex-Dokumenten, Emails und weiteren Office-Anwendungen.
